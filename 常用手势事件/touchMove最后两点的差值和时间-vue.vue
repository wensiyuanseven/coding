<template>
  <section class="press-move">
    <div class="demo" v-gesture:pressMove="pressMove" v-gesture:touchEnd="touchOrMouse" v-gesture:mouseUp="touchOrMouse" :style="{ transform: `translate3d(${distanceX}px,${distanceY}px,0)` }"></div>
  </section>
</template>

...
//--------------------------------------
    ...
    */
    function watch(target, prop, callback) {
        // 初始化时监听所有值，  比较高效
        // defineProperty监听属性值，只要有变化可以映射到所有属性身上
        // 监听所有属性
        // 注意，它设置的是prop,前面不带__ 所以获取的时候也是原始值
    ...
    window.Transform = function (element) {
        ...
        observe(
            ...
            function () {
                ...
                console.log(element.translateX,'---')
                var mtx = element.matrix3D.identity().appendTransform( element.translateX, element.translateY, element.translateZ, element.scaleX, element.scaleY, element.scaleZ, element.rotateX, element.rotateY, element.rotateZ,element.skewX,element.skewY, element.originX, element.originY, element.originZ);
                // 1.997258186340332,0,0,0,0,1.997258186340332,0,0,0,0,1,0,-85.68492889404297,111.01431274414062,0,1
                // console.log(mtx,'--',Array.prototype.slice.call(mtx.elements).join(","))
